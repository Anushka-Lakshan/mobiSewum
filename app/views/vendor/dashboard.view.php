...
<head>
    ...
    <title>Mobisewum Vendor Dashboard</title>
...
<body>
    ...
    <div class="container-fluid main-container">
        <div class="row">
            <nav class="col-2 bg-dark text-white sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?php if ($subpage == 'main') echo 'active'; ?>" href="<?= BASE_URL ?>/vendor-dashboard">Dashboard <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($subpage == 'mobiles') echo 'active'; ?>" href="<?= BASE_URL ?>/vendor-dashboard?page=mobiles">Mobiles</a>
                        </li>
            ...
            <?php include("app/views/vendor/subpages/$subpage.view.php"); ?>
